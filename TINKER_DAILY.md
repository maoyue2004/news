...
- `summaryZh` — 3-5 句，**150-260 字**。说清这篇干了什么、结论是什么、有什么具体数字。
  不写「本文介绍了……」这种空话。
  （原来写的是 80-160 字，但从创刊起实际一直写在 200 字上下，
  REVIEW 里连记了三次「这次仍然照实践写」——2026-08-13 改文档对齐实践。
  下限抬到 150 是因为不到这个字数装不下「干了什么 + 结论 + 数字」三件事。）
