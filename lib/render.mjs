...
// page.css / logic.js / ui.js 都是必需品，没有「可选」语义：任一缺失都会
// 产出一个能正常写入但功能残缺（无样式/无交互）的白页，且不会有任何报错。
// 这里让 readFileSync 直接抛错，把故障挡在构建期而不是发布后。
...
<div class="app">
  <header class="masthead">
    ...
    <span class="sync-status" id="sync-status" aria-live="polite">云端同步中…</span>
    <div class="toolbar">
