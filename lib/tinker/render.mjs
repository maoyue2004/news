...
import { vocabNames } from './vocab.mjs';
...
export function renderPage({ days, sources, status, generatedAt }) {
  const names = vocabNames();
  const data = embed({ days, sources, status, names, generatedAt });
  ...
  <div class="frame">
    <aside class="rail">
      ...
      <div class="rail-block">
        ...
        <div id="tools" class="tag-list"></div>
      </div>
      <div class="rail-block">
        <p class="rail-label">按话题</p>
        <div id="topics" class="tag-list"></div>
      </div>
      <div class="rail-block">
