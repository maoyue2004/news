...
export const TOPICS = [
  ...
  { id: 'skills', name: 'Agent Skills', aka: ['agent skill', 'claude skills', 'skill.md', '.claude/skills', 'skills 目录', 'code 技能包'] },
 ...
 */
const UNQUERYABLE = new Set(['copilot', 'zed', 'dia', 'comet', 'crush', 'goose', 'jules', 'amp', 'manus', 'hermes', 'trae-work', 'pi', 'cordis']);
